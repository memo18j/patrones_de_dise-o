...
class History {
  ...
  push(memento: DrawingMemento): void {
    ...
    console.log('%cMemento guardado en la historia.', COLORS.green);
  }
  ...
  pop(): DrawingMemento | undefined {
    ...
    if (memento) {
      console.log('%cMemento recuperado de la historia.', COLORS.green);
    } else {
      console.log('%cNo hay mementos para recuperar.', COLORS.red);
    }
    return memento;
  }
}
